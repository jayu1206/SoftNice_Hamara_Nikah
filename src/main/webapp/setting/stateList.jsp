...
ArrayList<statesBean> list=new ArrayList<statesBean>();
									...
									<div class="col-xs-12">
										...
										<% if(list.size()>0){%>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<% for(statesBean state: list){ %>
													<tr>
														<td><%=state.getName() %></td>
														<td class="hidden-780"><%=state.getCountryName() %></td>
														
														<td class="hidden-480">
															<span class="label label-sm label-warning"><%=state.isStatus() %></span>
														</td>
